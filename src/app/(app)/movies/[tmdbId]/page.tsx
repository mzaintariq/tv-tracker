...
export default async function MovieDetailPage({ params }: { params: Promise<{ tmdbId: string }> }) {
  ...
  if (!movie) notFound();
  const image = posterUrl(movie.media.poster_path, "w500");
