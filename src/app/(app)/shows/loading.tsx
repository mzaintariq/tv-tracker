    ...
    <div className="mx-auto w-full max-w-6xl space-y-10">
      ...
      <div aria-hidden="true" className="animate-pulse space-y-10">
        <section className="space-y-3">
          <div className="h-8 w-40 rounded bg-[var(--surface-elevated)]" />
        ...
        <section className="space-y-3">
          <div className="h-8 w-52 rounded bg-[var(--surface-elevated)]" />
          <div className="h-48 rounded-xl bg-[var(--surface-elevated)]" />
        </section>
        <section className="space-y-3">
          <div className="h-8 w-44 rounded bg-[var(--surface-elevated)]" />
