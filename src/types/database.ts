  ...
  public: {
    Tables: {
      ...
      media_items: {
        Row: {
          ...
          rich_metadata_synced_at: string | null;
      ...
      episodes: {
        ...
        Relationships: [
          {
            foreignKeyName: "episodes_media_item_id_fkey";
            columns: ["media_item_id"];
            isOneToOne: false;
            referencedRelation: "media_items";
            referencedColumns: ["id"];
      ...
      source_media_mappings: {
        ...
        Update: Partial<
          Database["public"]["Tables"]["source_media_mappings"]["Insert"]
        >;
        Relationships: [];
      };
      import_items: {
        Row: {
          ...
          match_claim_token: string | null;
          match_claimed_at: string | null;
          match_claim_expires_at: string | null;
          last_error_code: string | null;
      ...
      import_issues: {
        ...
        Update: Partial<
          Database["public"]["Tables"]["import_issues"]["Insert"]
        >;
        Relationships: [];
      };
    };
    ...
    Functions: {
      ...
      mark_episode_unwatched: {
        Args: { p_media_item_id: string; p_episode_id: string };
        Returns: undefined;
      };
      update_episode_watched_at: {
        Args: {
          p_media_item_id: string;
          p_episode_id: string;
          p_watched_at: string;
      ...
      initialize_user_show: {
        Args: {
          p_media_item_id: string;
          p_mode: string;
          p_season_number?: number | null;
          p_episode_number?: number | null;
          p_season_numbers?: number[] | null;
          p_watched_at?: string;
        };
        Returns: undefined;
      };
      initialize_tv_time_import: {
        Args: {
          p_user_id: string;
      ...
      claim_import_items_for_matching: {
        Args: {
          p_user_id: string;
          p_import_id: string;
          p_limit: number;
        ...
        Returns: { item_id: string; claim_token: string }[];
      };
      skip_all_unresolved_tv_time_media: {
      ...
      skip_unresolved_tv_time_media_by_type: {
        Args: { p_user_id: string; p_import_id: string; p_media_type: string };
        Returns: number;
      };
      skip_missing_tv_time_coordinates: {
        Args: {
          p_user_id: string;
          p_import_id: string;
          p_import_item_id: string | null;
        };
        Returns: number;
      };
      get_tv_time_import_apply_progress: {
        Args: { p_import_id: string };
        Returns: Json;
      };
      complete_import_match_claim: {
        Args: {
          p_user_id: string;
          p_item_id: string;
          p_claim_token: string;
          p_status: string;
          p_tmdb_id: number | null;
          p_candidates: number[];
      ...
      confirm_tv_time_import_mapping: {
        Args: {
          p_user_id: string;
          p_import_id: string;
          p_item_id: string;
      ...
      skip_tv_time_import_item: {
        Args: { p_user_id: string; p_import_id: string; p_item_id: string };
        Returns: undefined;
      };
      resolve_tv_time_import_issue: {
        Args: {
          p_user_id: string;
          p_import_id: string;
          p_issue_id: string;
      ...
      set_tv_time_import_paused: {
        Args: { p_user_id: string; p_import_id: string; p_paused: boolean };
        Returns: undefined;
      };
      start_tv_time_import_apply: {
        Args: { p_user_id: string; p_import_id: string };
        Returns: undefined;
      };
      recalculate_tv_time_import_status: {
        Args: { p_user_id: string; p_import_id: string };
        Returns: string;
      };
      delete_tv_time_import: {
        Args: { p_user_id: string; p_import_id: string };
        Returns: undefined;
      };
      apply_tv_time_show_import: {
        Args: {
          p_user_id: string;
          p_import_id: string;
          ...
          p_episode_events: Json;
        };
        Returns: Json;
      };
      apply_tv_time_movie_import_batch: {
        Args: { p_user_id: string; p_import_id: string; p_items: Json };
        Returns: Json;
      };
      forget_tv_time_import_data: {
...
export type WatchedEpisode =
  Database["public"]["Tables"]["watched_episodes"]["Row"];
