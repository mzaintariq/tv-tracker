...
export function EpisodeControls({ tmdbId, mediaId, episode, watched }: { tmdbId: number; mediaId: string; episode: Episode; watched: WatchedEpisode | undefined }) {
  const [pending, start] = useTransition();
